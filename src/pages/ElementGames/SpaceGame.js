...
import BGImage from "./Image/space.jpg";
import Earth from "./Image/earth.png";
import Planet1 from "./Image/planet1.png";
import Planet2 from "./Image/planet2.png";
import Planet3 from "./Image/planet3.png";
import Planet4 from "./Image/planet4.png";
import RocketImage from "./Image/rocket.png";
import RocketThrust from "./Image/rocketThrust.png";
import Asteroid from "./Image/asteroid.png";
...
export default function SpaceGame() {
  ...
  useEffect(() => {
    ...
    planet1.src = Planet1;
    planetImages.push(planet1);
    planets.push(planet1);

    let planet2 = new Image();
    planet2.src = Planet2;
    planetImages.push(planet2);
    planets.push(planet2);

    let planet3 = new Image();
    planet3.src = Planet3;
    planetImages.push(planet3);
    planets.push(planet3);

    let planet4 = new Image();
    planet4.src = Planet4;
    planetImages.push(planet4);
    ...
    function createAsteroidLine(
      ...
      for (let i = 0; i < numAsteroids; i++) {
        ...
        let asteroidY =
          startY + fraction * dy + (Math.random() - 0.5) * lineWidth;
  ...
  return (
    <div className="spaceGameContent">
      <GameNav />

      <div class="instruction">
        <div id="dInstruction" class="instructionPrompt">
          <p>
            Press space bar to apply thrust and move the Rocket to reach the
            Earth. Use fuel efficiently.
            <br />
            <p id="fuelInstruction">
              Green bar at the top indicates the fuel left
            </p>
            <br />
        ...
        <div id="mInstruction" class="instructionPrompt">
          <p>
            Tap on Screen to apply thrust and move the Rocket to reach the
            Earth. Use fuel efficiently.
            <br />
            <p id="fuelInstruction">
              Green bar at the top indicates the fuel left
      ...
      <div class="gameOver">
        ...
        <div id="won" class="prompt">
          <p>You Reached Earth!!</p>
          <div class="buttons">
            <button onClick={reload}>Play Again</button>
            <Link to="/gaming-zone"><button>Exit</button></Link>
          </div>
        </div>
        <div id="lowFuel" class="prompt">
        ...
        <div id="lostInSpace" class="prompt">
